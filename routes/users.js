module.exports = app => {
    ...
    app.route("/user")
        ...
        /**
         * @api {get} /user Exibe o usuário autenticado
         * @apiGroup Usuário
        ...
        /**
         * @api {delete} /user Exclui o usuário autenticado
         * @apiGroup Usuário
         * @apiHeader {String} Authorization Token de usuário
         * @apiHeaderExample {json} Header
         *  {"Authorization": "Bearer xyz.abc.123.hgf"}
        ...
        .delete((req, res) => {
            Users.destroy({where: {id: req.user.id}})
                ...
                .catch(error => {
                    res.statu(412).json({msg: error.message});
                });
        });

    /**
     * @api {get} /users Cadastra um novo usuário
     * @apiGroup Usuário
